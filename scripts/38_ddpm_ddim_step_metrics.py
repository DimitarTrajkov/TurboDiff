"""
38_ddpm_ddim_step_metrics.py

Evaluate the base google/ddpm-cifar10-32 model with the DETERMINISTIC DDIM
...
Usage:
    python 38_ddpm_ddim_step_metrics.py --device cuda:2
    python 38_ddpm_ddim_step_metrics.py --device cuda:3 --steps 25 12 8 --num-samples 10000
    python 38_ddpm_ddim_step_metrics.py --device cuda:2 --num-samples 2000   # quick sanity run
"""
...
def main():
    ...
    parser.add_argument("--steps", type=int, nargs="+", default=[25, 12, 8])
